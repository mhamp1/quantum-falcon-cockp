...
export default function XPPerksShop() {
  ...
  const [activatedPerks, setActivatedPerks] = useKV<
    Array<{ id: string; expiresAt: number }>
  >("activated-perks", []);
              ...
              >
                ...
                <div className="p-5 relative">
                  <div className="flex items-start gap-3 mb-4">
                    <div
                      className={`p-3 border-2 jagged-corner ${colorClasses[perk.color as keyof typeof colorClasses]}`}
                    >
                      {perk.icon}
                    </div>
