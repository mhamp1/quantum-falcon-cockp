...
export default function SocialCommunity() {
  ...
  const strategies: Strategy[] = [
    ...
    },
    {
      ...
      authorAvatar: "💎",
      description:
        "Smart dollar-cost averaging that buys dips based on support levels and Fibonacci retracement zones",
      winRate: 68.2,
      totalTrades: 523,
      roi: 89.7,
      likes: 521,
  ...
  const forumPosts: ForumPost[] = [
    {
      ...
      content:
        "Has anyone found optimal RSI thresholds for the current volatile market? I'm testing 30/70 vs 20/80...",
      likes: 45,
      comments: 23,
      views: 234,
    ...
    },
    {
      ...
      content:
        "After 3 months of consistent trading with the DCA and momentum strategies, here are my results...",
      likes: 178,
      comments: 67,
      views: 892,
    ...
    },
    {
      ...
      content:
        "Would love to see analysis across 1m, 5m, 15m, 1h timeframes simultaneously...",
      likes: 92,
      comments: 34,
      views: 456,
            ...
            <div className="flex items-start justify-between mb-6">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  />
                  <h3 className="text-3xl font-black uppercase tracking-[0.2em] text-accent">
                    Special Offers
                  </h3>
                </div>
                <p className="text-xs text-muted-foreground uppercase tracking-[0.15em]">
                  Premium features rotating every 3 days • Higher-tier
                  enhancements
                </p>
              </div>
              <div className="cyber-card-accent p-3 text-center">
                ...
                <div className="text-lg font-bold text-accent hud-value">
                  {timeUntilRotation.days}d {timeUntilRotation.hours}h{" "}
                  {timeUntilRotation.minutes}m
                </div>
              </div>
            </div>
                      ...
                      >
                        ...
                        <div className="relative z-10 pt-2">
                          <div className="flex items-center justify-center mb-4">
                            <div
                              className={`p-4 ${colors.bg} border ${colors.border} jagged-corner-small`}
                            >
                              <Icon
                                size={40}
                                weight="duotone"
                          ...
                          <div className="text-center space-y-2 mb-4">
                            <h4
                              className={`font-bold uppercase tracking-[0.12em] text-sm ${colors.text}`}
                            >
                              {offer.title}
                            </h4>
                            {offer.subtitle && (
                    ...
                    <TooltipContent className="cyber-card-accent border-2 border-accent max-w-sm p-4 z-50">
                      <div className="space-y-3">
                        ...
                        <div className="text-[10px] text-muted-foreground italic pt-2 border-t border-border/50">
                          Hover over cards to see details • Offers rotate every
                          3 days
                        </div>
                      </div>
                    </TooltipContent>
