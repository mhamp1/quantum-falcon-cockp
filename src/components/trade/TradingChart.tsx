    ...
    <div className="cyber-card" role="region" aria-label="Trading chart">
      <div className="p-6">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(20, 241, 149, 0.05) 1px, transparent 1px), linear-gradient(to bottom, rgba(20, 241, 149, 0.05) 1px, transparent 1px)",
        ...
        <div className="mt-4 p-4 bg-primary/10 border border-primary/30">
          <p className="text-xs text-muted-foreground">
            <strong className="text-primary">
              SciChart Integration Ready:
            </strong>{" "}
            High-performance candlestick charts with zoom/pan controls,
            technical indicators (SMA, RSI, MACD), volume analysis, and
            real-time WebSocket updates. Capable of rendering millions of data
            points at 60 FPS.
          </p>
        </div>
      </div>
