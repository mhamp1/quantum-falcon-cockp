...
const ALL_STRATEGIES: Strategy[] = [
  {
    ...
    longDescription:
      "Dollar Cost Averaging (DCA) helps reduce the impact of volatility by spreading purchases over time. This basic strategy executes buys at fixed intervals.",
    benefits: [
      "Reduces timing risk",
  ...
  },
  {
    ...
    type: "Smart DCA",
    description:
      "AI-optimized DCA that adjusts purchase amounts based on market conditions",
    longDescription:
      "Advanced DCA uses machine learning to optimize purchase timing and amounts. Buys more during dips and less during peaks for improved cost basis.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "Momentum trading captures trends by entering positions when price action shows strong directional movement. Uses technical indicators to confirm trend strength.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "RSI strategy identifies overbought (>70) and oversold (<30) conditions, entering counter-trend positions. Advanced divergence detection finds high-probability reversals.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "Multi-timeframe momentum analysis confirms trends across 5m, 15m, 1h, and 4h charts. Only enters when all timeframes align for maximum probability.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "MACD strategy uses the Moving Average Convergence Divergence indicator to identify trend changes. Enters on bullish crossovers, exits on bearish crossovers.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "Bollinger Bands adapt to market volatility, expanding during volatile periods and contracting during calm periods. Strategy trades bounces and breakouts.",
    benefits: [
      "Adapts to volatility",
  ...
  },
  {
    ...
    longDescription:
      "Mean reversion strategy identifies when prices have deviated significantly from their average, entering positions expecting a return to the mean.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "Token sniping bot monitors Raydium and other DEXs for new liquidity pools, executing buy orders within seconds of launch for first-mover advantage.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "Arbitrage scanner monitors price discrepancies across multiple exchanges, automatically executing trades to capture risk-free profit from price differences.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "AI that selects and switches between strategies based on market regime",
    longDescription:
      "Advanced AI analyzes current market conditions (trending, ranging, volatile) and automatically activates the most suitable strategy. Continuously learns from results.",
    benefits: [
  ...
  },
  {
    ...
    longDescription:
      "Create custom trading strategies using a no-code visual builder. Combine indicators, set conditions, and backtest before deployment.",
    benefits: [
...
export default function AdvancedTradingHub() {
  ...
  const [strategies, setStrategies] = useKV<Strategy[]>(
    "trading-strategies",
    ALL_STRATEGIES,
  );
  ...
  const dca =
    strategies?.filter(
      (s) => s.type.includes("DCA") || s.type.includes("Cost"),
    ) || [];
  const momentum =
    strategies?.filter(
      (s) => s.type.includes("Momentum") || s.type.includes("Trend"),
    ) || [];
  const advanced =
    strategies?.filter(
      (s) =>
    ...
    <div className="space-y-6">
      <div className="cyber-card p-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold tracking-[0.2em] uppercase">
                <span className="text-accent neon-glow-accent">
                  TRADING_HUB
                </span>
              </h1>
          ...
          <p className="text-sm text-muted-foreground mt-3">
            ...
            . Trending markets activate momentum strategies, while ranging
            markets trigger mean reversion and RSI strategies.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="cyber-card p-4">
          ...
          <div className="technical-readout text-3xl">
            {strategies?.reduce((acc, s) => acc + (s.tradesExecuted || 0), 0) ||
              0}
          </div>
        </div>
        <div className="cyber-card p-4">
          ...
          <div className="technical-readout text-3xl text-primary">
            +$
            {strategies?.reduce((acc, s) => acc + (s.pnl || 0), 0).toFixed(2) ||
              "0.00"}
          </div>
        </div>
        <div className="cyber-card p-4">
          ...
          <div className="technical-readout text-3xl text-accent">
            {strategies && strategies.filter((s) => s.winRate).length > 0
              ? (
                  strategies
                    .filter((s) => s.winRate)
                    .reduce((acc, s) => acc + (s.winRate || 0), 0) /
      ...
      <Tabs defaultValue="all" className="w-full">
        <TabsList className="w-full justify-start bg-card border-2 border-primary/30 p-1 jagged-corner">
          <TabsTrigger
            value="all"
            className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary uppercase tracking-wider text-xs font-bold"
          >
            All Strategies
          </TabsTrigger>
          <TabsTrigger
