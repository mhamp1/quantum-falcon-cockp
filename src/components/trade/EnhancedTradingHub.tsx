  ...
  const [strategies, setStrategies] = useKV<Strategy[]>("active-strategies", [
    {
      ...
      risk: "medium",
      description:
        "Captures short-term momentum swings in SOL/USDC pair using technical indicators",
    },
    {
      id: "2",
      ...
      risk: "low",
      description:
        "Dollar cost averaging into BTC every 6 hours regardless of price",
    },
    {
      id: "3",
      ...
      risk: "high",
      description:
        "Automatically detects and buys new token launches on Raydium",
    },
  ]);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="cyber-card p-4">
          ...
          <div
            className={`text-2xl font-bold hud-value ${totalPnL >= 0 ? "text-primary" : "text-destructive"}`}
          >
            {totalPnL >= 0 ? "+" : ""}
          ...
          <div key={strategy.id} className="cyber-card p-6 space-y-4">
            <div className="flex items-start justify-between">
              <div className="flex-1 space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <Badge
                    variant={
                      strategy.status === "active" ? "default" : "outline"
                    }
                ...
                <div className="flex items-center gap-6 text-xs">
                  ...
                  <div>
                    ...
                    <span className="ml-2 font-bold">
                      {formatTimeSince(strategy.lastTrade)}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 pt-4 border-t border-primary/30">
              <div className="space-y-1">
                ...
                <div
                  className={`text-lg font-bold hud-value ${
                    strategy.pnl >= 0 ? "text-primary" : "text-destructive"
                  }`}
                >
                  {strategy.pnl >= 0 ? "+" : ""}
                  {strategy.pnl.toFixed(2)} USD
                </div>
                <div
                  className={`text-xs ${
      ...
      {strategies.length === 0 && (
        <div className="cyber-card p-12 text-center">
          ...
          <Button className="jagged-corner-small">Create Strategy</Button>
        </div>
      )}
    </div>
  );
