  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (result.valid && result.tier && result.expiresAt) {
        toast.success(
          `License verified! Welcome to ${result.tier.toUpperCase()} tier`,
        );
            ...
            <div className="pt-4 border-t border-primary/30">
              <div className="flex items-start gap-2 text-xs text-muted-foreground">
                ...
                <p className="uppercase tracking-wide leading-relaxed">
                  Your license key is verified against our secure servers. No
            ...
            <div className="text-center">
              ...
              <div className="space-y-2">
                ...
                <Button
                  ...
                  onClick={() =>
                    onSuccess("free", Date.now() + 30 * 24 * 60 * 60 * 1000)
                  }
                >
