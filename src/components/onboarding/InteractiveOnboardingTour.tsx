...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description: 'These 4 cards above show your money growing in real-time.',
    instruction: 'Click any stat card shown above this tutorial panel',
    targetTab: 'dashboard',
  ...
  },
  {
    ...
    description: 'Look above — our AI predicts the next hour with up to 92% confidence.',
    instruction: 'Hover over the green confidence bar above',
    targetTab: 'dashboard',
  ...
  },
  {
    ...
    description: 'The buttons above let you start your bot, check vault, or upgrade.',
    instruction: 'Click the "Start Bot" button shown above',
    targetTab: 'dashboard',
  ...
  },
  {
    ...
    instruction: 'Drag the slider above to 50 or higher',
  ...
  },
  {
    ...
    description: 'The feature cards above show full Monaco editor, real-time backtesting, and one-click sharing.',
  ...
  },
  {
    ...
    description: 'DCA Basic is free forever. Unlock more strategies with Pro+.',
  ...
  },
  {
    ...
    description: 'The buttons above let you deposit funds — profits auto-convert to BTC here.',
    instruction: 'Click the "Deposit BTC" button shown above',
    targetTab: 'vault',
  ...
  },
  {
    ...
    instruction: 'Click "Launch Bot" below to finish',
    actionType: 'none',
  },
];
