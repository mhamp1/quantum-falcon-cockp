    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-10 relative z-10">
        <div className="flex items-center gap-5">
          ...
          >
            ...
            <Target
              ...
              style={{
                ...
                filter: `drop-shadow(0 0 10px ${currentLevel.color})`,
                position: "relative",
                zIndex: 10,
              }}
            />
          ...
          <div>
            ...
            <p
              className="text-sm uppercase tracking-[0.2em] text-cyan-400/70 font-semibold"
              style={{
      ...
      <div className="space-y-10 relative z-10">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(10, 10, 26, 0.6), rgba(26, 26, 46, 0.4))",
          ...
          <div className="relative mb-6">
            ...
            <motion.div
              ...
              animate={
                isAnimating
                  ? {
                      boxShadow: `0 0 40px rgba(${currentLevel.glowColor}, 1), 0 0 80px rgba(${currentLevel.glowColor}, 0.8)`,
                    }
                  : {}
              }
            />
          ...
          {[0, 50, 100].map((mark) => (
            <div
              ...
              style={{
                ...
                color:
                  aggressionValue >= mark - 5 && aggressionValue <= mark + 5
                    ? currentLevel.color
                    : "rgba(150, 150, 150, 0.5)",
                textShadow:
                  aggressionValue >= mark - 5 && aggressionValue <= mark + 5
                    ? `0 0 10px ${currentLevel.color}`
                    : "none",
              }}
            >
              {mark}
                  ...
                  <div className="flex items-center justify-center mb-4">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: isActive
                          ? `0 0 20px ${level.color}, inset 0 0 20px rgba(${level.glowColor}, 0.2)`
                          : "none",
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(40, 40, 60, 0.4), rgba(30, 30, 50, 0.3))",
          ...
          animate={
            isAnimating
              ? { borderColor: `rgba(${currentLevel.glowColor}, 0.8)` }
              : {}
          }
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(0, 200, 255, 0.3) 10px, rgba(0, 200, 255, 0.3) 11px)",
            }}
          />
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div className="flex-1">
              ...
              <p
                className="text-sm uppercase tracking-wide leading-relaxed"
                style={{
                  color: "rgba(180, 180, 200, 0.8)",
                }}
              >
                Bot will dynamically adapt strategies based on real-time market
                conditions and selected aggression level. Position sizing,
                stop-losses, and trade frequency will be automatically adjusted.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <div className="absolute top-4 right-4 w-32 h-32 opacity-10 pointer-events-none">
        <motion.div
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, transparent, transparent 8px, rgba(0, 200, 255, 0.5) 8px, rgba(0, 200, 255, 0.5) 9px)",
            width: "100%",
            height: "100%",
          }}
          animate={{ rotate: 360 }}
