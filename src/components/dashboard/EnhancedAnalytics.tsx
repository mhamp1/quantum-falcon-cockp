        ...
        <div className="cyber-card angled-corners-dual-tl-br p-6 space-y-4">
          ...
          <div className="space-y-3">
            {assetPerformance.map((asset, idx) => (
              <div
                key={asset.symbol}
                className={`bg-muted/30 p-4 space-y-2 ${idx % 2 === 0 ? "angled-corner-tr" : "angled-corner-br"}`}
              >
                <div className="flex items-center justify-between">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-3">
                <TrendDown
                  ...
                  weight="fill"
                />
                <span className="text-xs uppercase tracking-[0.2em] text-destructive font-bold">
                  Worst Trade
                </span>
              </div>
