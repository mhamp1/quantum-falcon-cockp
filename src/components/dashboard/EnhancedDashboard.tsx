...
const QuickStatsCard = lazy(() =>
  import("./QuickStatsCard").then((m) => ({ default: m.QuickStatsCard })),
);
const QuickActionButton = lazy(() =>
        ...
        >
          <div className="cyber-card relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-64 h-64 opacity-10">
              <Suspense
                fallback={
                  <div className="w-64 h-64 animate-pulse bg-muted/10" />
                }
              >
                <Wireframe3D
                  type="sphere"
  ...
  return (
    <ErrorBoundary>
      ...
      >
        <Suspense
          fallback={
            <div className="animate-pulse h-8 bg-muted/20 rounded border border-primary/20" />
          }
        >
          <NewsTicker />
        </Suspense>
        ...
        >
          {statsGrid.map((stat, idx) => (
            <Suspense
              key={stat.id}
              fallback={
                <div className="animate-pulse h-32 bg-muted/20 rounded border border-primary/20" />
              }
            >
        ...
        <Suspense
          fallback={
            <div className="animate-pulse h-48 bg-muted/20 rounded border border-primary/20" />
          }
        >
          <AIAdvisor />
        </Suspense>
        ...
        <Suspense
          fallback={
            <div className="animate-pulse h-64 bg-muted/20 rounded border border-accent/20" />
          }
        >
          <BotLogs />
        </Suspense>
