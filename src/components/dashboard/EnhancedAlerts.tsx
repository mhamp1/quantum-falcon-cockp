    ...
    const generateAlert = () => {
      const alertTypes: Array<{
      ...
      }> = [
        {
          ...
          reason:
            "Large institutional buy detected. Volume increased 340% above 24h average. Bot adjusted position sizing automatically.",
          severity: "high",
        ...
        },
        {
          ...
          reason:
            "Social media mentions increased 280%. Positive sentiment ratio jumped from 52% to 87%. News articles about institutional adoption trending.",
          severity: "medium",
        ...
        },
        {
          ...
          reason:
            "Market volatility decreased below threshold. RSI indicating overbought conditions. Historical data suggests mean reversion performs better in current regime.",
          severity: "medium",
        },
        {
          type: "anomaly",
          ...
          reason:
            "Unusual trading activity detected. Whale wallets moving significant amounts. Bot increased monitoring frequency and tightened stop-losses.",
          severity: "high",
        ...
        },
        {
          ...
          reason:
            "Market volatility index exceeded safe threshold. Bot automatically reduced exposure by 30% across all positions to protect capital.",
          severity: "medium",
        },
      ];
