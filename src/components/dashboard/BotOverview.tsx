...
export default function BotOverview() {
  ...
  const [aggressionLevel, setAggressionLevel] = useKV<AggressionLevel>(
    "bot-aggression",
    "moderate",
  );
  const [aggressionValue, setAggressionValue] = useKV<number>(
    "bot-aggression-value",
    50,
  );
  ...
  const getAggressionIcon = (level: AggressionLevel) => {
    switch (level) {
      case "cautious":
        return (
          <ShieldCheck size={24} weight="fill" className="text-secondary" />
        );
      case "moderate":
        return (
          <ShieldWarning size={24} weight="fill" className="text-accent" />
        );
      case "aggressive":
  ...
  const toggleAgent = (agent: keyof BotConfig) => {
    ...
    toast.success(
      `${agentName} ${config?.[agent].enabled ? "paused" : "resumed"}`,
    );
  };
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            ...
            <div className="flex-1 space-y-4">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <h2 className="text-3xl md:text-4xl font-bold tracking-[0.2em] uppercase">
                    ...
                    <span className="text-primary neon-glow-primary ml-2">
                      SYSTEM
                    </span>
                  </h2>
                ...
                <p className="text-sm uppercase tracking-[0.15em] text-muted-foreground font-semibold">
                  AUTONOMOUS AI TRADING ARCHITECTURE // REAL-TIME MARKET
                  INTELLIGENCE
                </p>
              </div>
              ...
              <p className="text-base leading-relaxed text-foreground">
                The{" "}
                <span className="text-secondary font-bold">Quantum Falcon</span>{" "}
                employs a sophisticated multi-agent AI architecture that
                combines{" "}
                ...
                to deliver autonomous trading intelligence. Each agent operates
                independently while coordinating through a shared knowledge base
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2">
                <div className="p-3 bg-muted/30 border-l-2 border-secondary hover:border-accent transition-all">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Continuous market scanning & pattern recognition
                  </p>
                </div>
                ...
                <div className="p-3 bg-muted/30 border-l-2 border-primary hover:border-secondary transition-all">
                  ...
                  <p className="text-xs text-muted-foreground">
                    RL optimization from historical performance
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="cyber-card group hover:scale-105 transition-all">
          <div className="p-4 relative z-10">
            ...
            <p className="text-4xl font-bold text-primary neon-glow-primary hud-value">
      ...
      >
        ...
        <TabsContent value="overview" className="mt-6 space-y-6">
          <div className="cyber-card">
            <div className="p-6 relative z-10">
              <h3 className="text-2xl font-bold uppercase tracking-[0.15em] text-primary hud-text mb-4">
                SYSTEM ARCHITECTURE
              </h3>
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 jagged-corner bg-primary/10 border-2 border-primary">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed mb-4">
                        Continuously scans the Solana ecosystem for trading
                        opportunities. Monitors price movements, liquidity
                        changes, new token launches, and market sentiment.
                      </p>
                      <div className="space-y-2">
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="text-primary font-bold">
                            {config.marketAnalyst.scanInterval}s
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          <span className="text-muted-foreground">
                          ...
                          <span className="text-primary font-bold">
                            $
                            {(config.marketAnalyst.minLiquidity / 1000).toFixed(
                              0,
                            )}
                            K
                          </span>
                        ...
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="text-primary font-bold">
                            {config.marketAnalyst.confidenceThreshold}%
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 jagged-corner bg-secondary/10 border-2 border-secondary">
                      <div className="flex items-center gap-3 mb-3">
                        <Robot
                          ...
                          className="text-secondary"
                        />
                        <h4 className="text-lg font-bold uppercase tracking-wide text-secondary">
                          AGENT 2
                        </h4>
                      </div>
                      <p className="text-sm font-bold uppercase tracking-wide mb-2">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed mb-4">
                        Executes trading strategies based on market signals.
                        Manages DCA schedules, snipes new tokens, calculates
                        position sizes, and handles risk management.
                      </p>
                      <div className="space-y-2">
                        <div className="flex justify-between text-xs">
                          <span className="text-muted-foreground">
                          ...
                          <span className="text-secondary font-bold">
                            ${config.strategyEngine.dcaAmount}
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          <span className="text-muted-foreground">
                          ...
                          <span className="text-secondary font-bold">
                            ${config.strategyEngine.snipeAmount}
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          <span className="text-muted-foreground">
                          ...
                          <span className="text-secondary font-bold">
                            {config.strategyEngine.maxSlippage}%
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 jagged-corner bg-accent/10 border-2 border-accent">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        />
                        <h4 className="text-lg font-bold uppercase tracking-wide text-accent">
                          AGENT 3
                        </h4>
                      </div>
                      <p className="text-sm font-bold uppercase tracking-wide mb-2">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed mb-4">
                        Reinforcement learning model that continuously improves
                        strategies. Learns from outcomes, adjusts parameters,
                        and optimizes portfolio allocation.
                      </p>
                      <div className="space-y-2">
                        <div className="flex justify-between text-xs">
                          <span className="text-muted-foreground">
                          ...
                          <span className="text-accent font-bold">
                            {config.rlOptimizer.learningRate}
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          <span className="text-muted-foreground">
                          ...
                          <span className="text-accent font-bold">
                            {(config.rlOptimizer.explorationRate * 100).toFixed(
                              0,
                            )}
                            %
                          </span>
                        ...
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="text-accent font-bold">
                            {config.rlOptimizer.trainingCycles}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3 text-sm text-muted-foreground">
                    <div className="flex items-center gap-3">
                      ...
                      <p>
                        ...
                        → Real-time price feeds, DEX liquidity pools, token
                        launches
                      </p>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <p>
                        ...
                        → Pattern recognition, volatility analysis, sentiment
                        scoring
                      </p>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <p>
                        ...
                        → DCA timing, snipe triggers, position sizing
                        calculations
                      </p>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <p>
                        ...
                        → Transaction building, slippage checks, confirmation
                        monitoring
                      </p>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <p>
                        ...
                        → Profit/loss calculation, model retraining, parameter
                        optimization
                      </p>
                    </div>
                  </div>
              ...
              <div className="p-6 relative z-10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button
                    ...
                    variant={
                      config.marketAnalyst.enabled ? "default" : "outline"
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="p-3 jagged-corner bg-muted/30 border border-primary/30">
                    ...
                    <p className="text-lg font-bold text-primary neon-glow-primary hud-value">
                      247
                    </p>
                  </div>
                  <div className="p-3 jagged-corner bg-muted/30 border border-primary/30">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-bold uppercase tracking-wide mb-2 text-foreground">
                      Capabilities
                    </h4>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          {config.marketAnalyst.scanInterval} second intervals
                          across Solana DEXs
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        />
                        <span>
                          Volatility detection at{" "}
                          {config.marketAnalyst.volatilityThreshold}% threshold
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        />
                        <span>
                          Pattern recognition using machine learning for trend
                          prediction
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        />
                        <span>
                          New token launch detection with instant liquidity pool
                          analysis
                        </span>
                      </li>
                    </ul>
              ...
              <div className="p-6 relative z-10">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold uppercase tracking-wide text-secondary">
                  ...
                  <Button
                    ...
                    variant={
                      config.strategyEngine.enabled ? "default" : "outline"
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="p-3 jagged-corner bg-muted/30 border border-accent/30">
                    ...
                    <p className="text-lg font-bold text-accent neon-glow-accent hud-value">
                      12
                    </p>
                  </div>
                  <div className="p-3 jagged-corner bg-muted/30 border border-accent/30">
                    ...
                    <div className="space-y-3">
                      <div className="p-3 bg-muted/30 border-l-2 border-secondary">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span
                            className={`text-xs px-2 py-1 jagged-corner-small border ${config.strategyEngine.dcaEnabled ? "bg-secondary/20 border-secondary text-secondary" : "bg-muted border-muted-foreground text-muted-foreground"}`}
                          >
                            {config.strategyEngine.dcaEnabled
                              ? "ENABLED"
                              : "DISABLED"}
                          </span>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          ...
                          {config.strategyEngine.dcaAmount} every{" "}
                          {config.strategyEngine.dcaInterval / 3600} hours to
                      ...
                      <div className="p-3 bg-muted/30 border-l-2 border-accent">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span
                            className={`text-xs px-2 py-1 jagged-corner-small border ${config.strategyEngine.snipeEnabled ? "bg-accent/20 border-accent text-accent" : "bg-muted border-muted-foreground text-muted-foreground"}`}
                          >
                            {config.strategyEngine.snipeEnabled
                              ? "ENABLED"
                              : "DISABLED"}
                          </span>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          Automatic detection and purchase of new token launches
                          with ${config.strategyEngine.snipeAmount} positions at{" "}
                          {config.strategyEngine.maxSlippage}% max slippage
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="p-6 relative z-10">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold uppercase tracking-wide text-accent">
                        RL Optimizer Agent
                      </h3>
                      <p className="text-sm text-muted-foreground uppercase tracking-wide">
                        A3_RL_OPT
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <Progress
                          value={config.rlOptimizer.learningRate * 1000}
                          className="h-2"
                        />
                      </div>
                      <div>
                        ...
                        <Progress
                          value={config.rlOptimizer.explorationRate * 100}
                          className="h-2"
                        />
                      </div>
                      <div className="p-3 bg-muted/30 border-l-2 border-accent">
                        <p className="text-xs text-muted-foreground">
                          The RL agent uses{" "}
                          {config.rlOptimizer.trainingCycles.toLocaleString()}{" "}
                          training cycles per optimization run, continuously
                          adapting to market conditions with a{" "}
                          {config.rlOptimizer.rebalanceThreshold}% rebalance
                          threshold.
                        </p>
                      </div>
                    </div>
        ...
        <TabsContent value="config" className="mt-6">
          <div className="cyber-card">
            <div className="p-6 relative z-10">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl font-bold uppercase tracking-[0.15em] text-primary hud-text">
              ...
              <div className="p-4 bg-destructive/10 border-l-4 border-destructive mb-6">
                <div className="flex items-start gap-3">
                  ...
                  />
                  <div>
                    <p className="text-sm font-bold text-destructive uppercase tracking-wide mb-1">
                      Configuration Notice
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Modifying these parameters will affect all agent behavior.
                      Changes take effect immediately and may impact active
                      trading strategies. Always test configuration changes in
                      demo mode before enabling live trading.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="p-4 jagged-corner bg-muted/30 border border-primary/30">
                  <h4 className="text-lg font-bold uppercase tracking-wide text-primary mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground">
                        ${config.marketAnalyst.minLiquidity.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <label className="text-xs text-muted-foreground uppercase tracking-wide font-bold block mb-2">
                      ...
                      <p className="text-sm text-foreground">
                        {config.marketAnalyst.volatilityThreshold}%
                      </p>
                    </div>
                    <div>
                      <label className="text-xs text-muted-foreground uppercase tracking-wide font-bold block mb-2">
                ...
                <div className="p-4 jagged-corner bg-muted/30 border border-secondary/30">
                  <h4 className="text-lg font-bold uppercase tracking-wide text-secondary mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground">
                        {config.strategyEngine.dcaInterval / 3600}h
                      </p>
                    </div>
                    <div>
                      <label className="text-xs text-muted-foreground uppercase tracking-wide font-bold block mb-2">
                ...
                <div className="p-4 jagged-corner bg-muted/30 border border-accent/30">
                  <h4 className="text-lg font-bold uppercase tracking-wide text-accent mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground">
                        {(config.rlOptimizer.explorationRate * 100).toFixed(0)}%
                      </p>
                    </div>
                    <div>
                      <label className="text-xs text-muted-foreground uppercase tracking-wide font-bold block mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground">
                        {config.rlOptimizer.rebalanceThreshold}%
                      </p>
                    </div>
                  </div>
                </div>
