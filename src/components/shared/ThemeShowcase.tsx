...
import { HolographicCard, HolographicCardHeader, HolographicCardTitle, HolographicCardDescription, HolographicCardContent } from '@/components/ui/holographic-card'
import { NeonProgress } from '@/components/ui/neon-progress'
import { NeonToast } from '@/components/ui/neon-toast'
import { NeonBadge } from '@/components/ui/neon-badge'
import { Sparkle, Rocket, Trophy, Star, Lightning } from '@phosphor-icons/react'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold uppercase tracking-[0.15em] mb-2">
            ...
            {' '}
            <span className="text-secondary neon-glow-secondary">NEON THEME</span>
          </h1>
        ...
        <HolographicCard className="mb-8">
          <HolographicCardHeader>
            ...
            <HolographicCardDescription>Solana Brand Colors</HolographicCardDescription>
          </HolographicCardHeader>
          <HolographicCardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-center text-muted-foreground uppercase">Solana Green</p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-xs text-center text-muted-foreground uppercase">Solana Purple</p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-xs text-center text-muted-foreground uppercase">Dark Background</p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-xs text-center text-muted-foreground uppercase">Darker Background</p>
              </div>
            </div>
          </HolographicCardContent>
        </HolographicCard>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <HolographicCard variant="primary" glow pulse>
            <HolographicCardHeader>
              <div className="flex items-center gap-3">
                <Sparkle size={24} weight="duotone" className="text-primary neon-glow-primary" />
                <HolographicCardTitle className="text-xl">Primary Card</HolographicCardTitle>
              </div>
              <HolographicCardDescription>With glow and pulse effect</HolographicCardDescription>
            </HolographicCardHeader>
            <HolographicCardContent>
              <p className="text-sm text-muted-foreground">
                This card features the primary color variant with animated glow and pulse effects for maximum visual impact.
              </p>
            </HolographicCardContent>
          </HolographicCard>
          ...
          <HolographicCard variant="secondary" glow>
            <HolographicCardHeader>
              <div className="flex items-center gap-3">
                <Rocket size={24} weight="duotone" className="text-secondary neon-glow-secondary" />
                <HolographicCardTitle className="text-xl">Secondary Card</HolographicCardTitle>
              </div>
              <HolographicCardDescription>With subtle glow effect</HolographicCardDescription>
            </HolographicCardHeader>
            <HolographicCardContent>
              <p className="text-sm text-muted-foreground">
                Secondary variant showcases the Solana purple theme with smooth transitions and neon aesthetics.
              </p>
            </HolographicCardContent>
          </HolographicCard>
          ...
          <HolographicCard variant="accent" glow>
            <HolographicCardHeader>
              <div className="flex items-center gap-3">
                <Lightning size={24} weight="duotone" className="text-primary neon-glow-primary" />
                <HolographicCardTitle className="text-xl">Accent Card</HolographicCardTitle>
              </div>
              <HolographicCardDescription>Solana green variant</HolographicCardDescription>
            </HolographicCardHeader>
            <HolographicCardContent>
              <p className="text-sm text-muted-foreground">
                Accent card uses the iconic Solana green for special highlights and call-to-action elements.
              </p>
            </HolographicCardContent>
          </HolographicCard>
        </div>
        ...
        <HolographicCard className="mb-8">
          <HolographicCardHeader>
            ...
            <HolographicCardDescription>Neon-themed progress indicators</HolographicCardDescription>
          </HolographicCardHeader>
        ...
        <HolographicCard className="mb-8">
          <HolographicCardHeader>
            ...
            <HolographicCardDescription>Status indicators and tags</HolographicCardDescription>
          </HolographicCardHeader>
          <HolographicCardContent>
        ...
        <HolographicCard>
          <HolographicCardHeader>
            ...
            <HolographicCardDescription>System alerts and messages</HolographicCardDescription>
          </HolographicCardHeader>
        ...
        <HolographicCard className="mt-8">
          <HolographicCardHeader>
            ...
            <HolographicCardDescription>Smooth transitions and effects</HolographicCardDescription>
          </HolographicCardHeader>
          <HolographicCardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-muted-foreground uppercase">Pulse Glow</p>
              </div>
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-muted-foreground uppercase">Pulse Slow</p>
              </div>
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-muted-foreground uppercase">Shimmer</p>
              </div>
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-muted-foreground uppercase">Neon Flicker</p>
              </div>
            </div>
          </HolographicCardContent>
        </HolographicCard>
