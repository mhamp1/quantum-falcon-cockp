...
export default function LicenseExpiry() {
      ...
      <div className="cyber-card p-4 border-2 border-destructive bg-destructive/10 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold uppercase tracking-wider text-destructive text-sm">
                License Expired
              </div>
  ...
  if (isWarning) {
    return (
      <div
        className={`cyber-card p-4 border-2 relative overflow-hidden ${
          isCritical
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div
              className={`p-2 border-2 jagged-corner-small ${
                isCritical
            ...
            >
              <Clock
                size={24}
                weight="fill"
                className={isCritical ? "text-destructive" : "text-secondary"}
              />
            </div>
            <div>
              <div
