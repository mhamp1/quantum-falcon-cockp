...
export default function LoginDialog({ open, onOpenChange }: LoginDialogProps) {
  ...
  const handleLogin = async () => {
    ...
    const mockLicense: UserLicense = {
      ...
      tier: licenseKey.startsWith("ELITE")
        ? "elite"
        : licenseKey.startsWith("PRO")
          ? "pro"
          : licenseKey.startsWith("LIFE")
            ? "lifetime"
            : "free",
      expiresAt: licenseKey.startsWith("LIFE")
        ? null
        ...
        <div className="cyber-card border-2 border-primary shadow-[0_0_50px_oklch(0.72_0.20_195_/_0.5)]">
          ...
          <div className="p-6 relative z-10">
            <p className="text-muted-foreground uppercase text-xs tracking-wider mb-4">
              Authenticate with your license key to access quantum falcon
              systems
            </p>

            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="email" className="data-label text-primary">
                  Email Address
                </Label>
              ...
              <div className="space-y-2">
                <Label
                  htmlFor="license-key"
                  className="data-label text-primary"
                >
                  License Key
                </Label>
                <div className="relative">
                ...
                <button
                  onClick={() => {
                    toast.info("Purchase License", {
                      description:
                        "Visit quantumfalcon.ai to purchase a license",
                    });
                  }}
