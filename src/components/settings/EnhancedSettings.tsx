                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {profile.xpToNextLevel - profile.xp} XP to Level{" "}
                      {profile.level + 1}
                    </p>
                  </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="glass-morph-card p-6 space-y-6 relative overflow-hidden group hover:shadow-[0_0_40px_oklch(0.65_0.25_25_/_0.3)] transition-all duration-500">
              ...
              >
                ...
                />
                <path
                  d="M 80 20 L 120 20 L 120 60 L 80 60 Z"
                  stroke="var(--destructive)"
                  strokeWidth="2"
                  fill="none"
                  strokeDasharray="3,3"
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold uppercase tracking-[0.2em] hud-text text-destructive">
                        SECURITY_CENTER
                      </h3>
                  ...
                  <div className="cyber-card-accent p-4 relative overflow-hidden group/card">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-xs text-muted-foreground mb-3">
                        Secure your account with biometric or PIN
                      </p>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(v) =>
                            handleUpdateSetting(["security", "biometric"], v)
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(v) =>
                            handleUpdateSetting(["security", "twoFactor"], v)
                          }
                        />
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2 text-xs text-muted-foreground">
                          <li className="flex items-center gap-2">
                            ...
                            Enable Two-Factor Authentication for maximum
                            protection
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="w-1 h-1 bg-primary rounded-full" />
        ...
        <TabsContent value="app" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-morph-card p-6 space-y-6 relative overflow-hidden group hover:shadow-[0_0_40px_oklch(0.72_0.20_195_/_0.3)] transition-all duration-500">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold uppercase tracking-[0.15em] hud-text text-primary">
                      NOTIFICATIONS
                    </h3>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all group/item relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <Label className="font-bold uppercase text-xs tracking-wider cursor-pointer">
                          TRADE_ALERTS
                        </Label>
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["notifications", "tradeAlerts"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["notifications", "priceAlerts"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["notifications", "pushEnabled"], v)
                      }
                    />
                  </div>
            ...
            <div className="glass-morph-card p-6 space-y-6 relative overflow-hidden group hover:shadow-[0_0_40px_oklch(0.68_0.18_330_/_0.3)] transition-all duration-500">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold uppercase tracking-[0.15em] hud-text text-accent">
                      AUDIO_SYSTEM
                    </h3>
                    <p className="text-xs text-muted-foreground uppercase tracking-wider">
                      SOUND_CONFIG
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["audio", "soundEffects"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["audio", "ambientMusic"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["audio", "voiceNarration"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="p-4 bg-background/40 backdrop-blur-sm border border-accent/20 space-y-3 relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between">
                      <Label className="font-bold uppercase text-xs tracking-wider">
                        VOLUME
                      </Label>
                      <span className="text-accent font-bold text-sm tabular-nums">
                        {settings.audio?.volume ?? 70}%
                      </span>
                    </div>
                    <Input
                      type="range"
            ...
            <div className="glass-morph-card p-6 space-y-6 relative overflow-hidden group hover:shadow-[0_0_40px_oklch(0.68_0.18_330_/_0.3)] transition-all duration-500">
              ...
              >
                <path
                  d="M 0 100%, L 60 100%, L 60 60, L 100% 60"
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-secondary/20 border border-secondary/40 jagged-corner-small relative">
                    ...
                    />
                    <div
                      className="absolute -bottom-1 -right-1 w-2 h-2 bg-secondary rounded-full animate-pulse"
                      style={{ animationDelay: "0.5s" }}
                    />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold uppercase tracking-[0.15em] hud-text text-secondary">
                      TRADING_CONFIG
                    </h3>
                    <p className="text-xs text-muted-foreground uppercase tracking-wider">
                      EXECUTION_SETTINGS
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-secondary/20 hover:border-secondary/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["trading", "paperMode"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-secondary/20 hover:border-secondary/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["trading", "confirmTrades"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-secondary/20 hover:border-secondary/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["trading", "autoCompound"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="p-4 bg-background/40 backdrop-blur-sm border border-secondary/20 space-y-2 relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-secondary font-bold text-sm tabular-nums">
                        {settings.trading?.slippage ?? 1.0}%
                      </span>
                    </div>
                    <Input
                      type="range"
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-destructive/20 border border-destructive/40 jagged-corner-small relative">
                    ...
                    />
                    <div
                      className="absolute -top-1 -left-1 w-2 h-2 bg-destructive rounded-full animate-pulse"
                      style={{ animationDelay: "0.7s" }}
                    />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold uppercase tracking-[0.15em] hud-text text-destructive">
                      SECURITY
                    </h3>
                    <p className="text-xs text-muted-foreground uppercase tracking-wider">
                      PROTECTION_LAYER
                  ...
                  <div className="ml-auto flex items-center gap-1">
                    <Shield
                      ...
                      className="text-destructive"
                    />
                    <span className="text-[9px] font-bold text-destructive tracking-wider">
                      SECURE
                    </span>
                  </div>
                </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-primary/20 border border-primary/40 jagged-corner-small relative">
                    ...
                    />
                    <div
                      className="absolute -bottom-1 -left-1 w-2 h-2 bg-primary rounded-full animate-pulse"
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-background/40 backdrop-blur-sm border border-primary/20 space-y-2 relative overflow-hidden">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        handleUpdateSetting(["network", "rpcEndpoint"], v)
                      }
                    >
                      <SelectTrigger className="bg-background/60">
                        <SelectValue />
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["network", "priorityFees"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="p-4 bg-primary/10 border border-primary/30 space-y-2 relative overflow-hidden">
                    ...
                    <p className="text-xs text-muted-foreground relative z-10">
                      ...
                      <span className="text-primary font-bold uppercase">
                        {settings.network?.rpcEndpoint ?? "mainnet"}
                      </span>
                    </p>
                  </div>
                </div>
            ...
            <div className="glass-morph-card p-6 space-y-6 relative overflow-hidden group hover:shadow-[0_0_40px_oklch(0.68_0.18_330_/_0.3)] transition-all duration-500">
              ...
              >
                <path
                  d="M 100% 100%, L 80% 100%, L 80% 70%, L 50% 70%"
                  stroke="var(--accent)"
                  strokeWidth="2"
                  fill="none"
                  strokeDasharray="4,4"
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["display", "compactMode"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["display", "showBalances"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["theme", "animations"], v)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all group/item relative overflow-hidden">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) =>
                        handleUpdateSetting(["theme", "glassEffect"], v)
                      }
                    />
                  </div>
                    ...
                    <Switch
                      ...
                      onCheckedChange={(v) => {
                        ...
                        const styles = document.querySelectorAll(
                          ".neon-glow, .neon-glow-primary, .neon-glow-secondary, .neon-glow-accent, .neon-glow-destructive",
                        );
                        styles.forEach((el) => {
                          if (v) {
                  ...
                  <div className="flex items-center justify-between p-4 bg-background/40 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all group/item relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-muted-foreground mt-0.5">
                          Accessibility mode (B&W cyberpunk)
                        </p>
                      </div>
                    </div>
                    <Switch
                      ...
                      onCheckedChange={(v) => {
                        ...
                        toast.success(
                          ...
                          {
                            description: v
                              ? "Enhanced readability with black & white theme"
                              : "Default color theme restored",
                          },
                        );
                      }}
                    />
                  ...
                  <div className="p-4 bg-background/40 backdrop-blur-sm border border-accent/20 space-y-2 relative overflow-hidden">
                    ...
                    <p className="text-[10px] text-muted-foreground mb-2">
                      Choose your cyberpunk aesthetic
                    </p>
                    <Select
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-3">
                      ...
                      >
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg, oklch(0.72 0.20 195), oklch(0.68 0.18 330))",
                          }}
                        />
                      ...
                      >
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg, oklch(0.60 0.20 145), oklch(0.40 0.15 160))",
                          }}
                        />
                        <p className="text-[9px] text-center font-bold uppercase">
                          Matrix
                      ...
                      >
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg, oklch(0.70 0.25 330), oklch(0.65 0.22 280))",
                          }}
                        />
                        <p className="text-[9px] text-center font-bold uppercase">
                          Synthwave
                  ...
                  <div className="p-4 bg-background/40 backdrop-blur-sm border border-accent/20 space-y-2 relative overflow-hidden">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        handleUpdateSetting(["display", "chartType"], v)
                      }
                    >
                      <SelectTrigger className="bg-background/60">
                        <SelectValue />
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-xl font-bold uppercase tracking-[0.2em] hud-text text-primary">
                    SYSTEM_STATUS
                  </h3>
                </div>
