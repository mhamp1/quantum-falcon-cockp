...
export default function APIIntegration() {
  const [connections, setConnections] = useKV<APIConnection[]>(
    "api-connections",
    [
      {
        id: "phantom",
  ...
  const [credentials, setCredentials] = useKV<APICredentials>(
    "api-credentials",
    {},
  );
                ...
                <div className="space-y-4 pt-4 border-t border-primary/30">
                  ...
                  <div className="bg-muted/30 p-3 jagged-corner-small flex items-start gap-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Your API credentials are encrypted using AES-256
                      encryption and stored securely. They are never transmitted
                      to external servers.
                    </p>
                  </div>
                ...
                <div className="pt-3 border-t border-primary/30 flex items-center justify-between">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      const decryptedKey = creds.apiKey
                        ? decryptData(creds.apiKey)
                        : "";
                      const decryptedSecret = creds.apiSecret
                        ? decryptData(creds.apiSecret)
                        : "";
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Never share your API keys or private keys with anyone. Enable IP
              restrictions and read-only permissions when possible. Quantum
              Falcon uses industry-standard encryption but you are responsible
              for the security of your accounts.
            </p>
          </div>
        </div>
      </div>
