...
export default function SubscriptionTiers() {
  const [currentTier, setCurrentTier] = useKV<string>(
    "subscription-tier",
    "free",
  );
  ...
  const tiers: SubscriptionTier[] = [
    {
      ...
      billingPeriod: "month",
      icon: (
        <Star size={32} weight="duotone" className="text-muted-foreground" />
      ),
      features: [
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-4 mt-6">
                <div className="p-3 bg-muted/30 rounded-lg">{tier.icon}</div>
                <div>
              ...
              {tier.id === "lifetime" && (
                <div className="bg-secondary/10 border border-secondary/30 p-4 jagged-corner-small">
                  <p className="text-xs text-center text-muted-foreground uppercase tracking-wide">
                    <strong className="text-secondary">Limited Offer:</strong>{" "}
                    Save $4,540 vs 5 years of Elite
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Our AI-powered trading system has generated over{" "}
              <strong className="text-accent">$2.4M in profits</strong> for our
              Pro and Elite members in the last quarter alone. The average Pro
              member sees their subscription cost returned within the first 2-3
              weeks of trading. Elite members average{" "}
              <strong className="text-accent">320% ROI</strong> annually.
            </p>
            <div className="grid grid-cols-3 gap-4 pt-3">
              ...
              <div className="text-center">
                <div className="text-2xl font-black text-accent hud-value">
                  2,847
                </div>
                <div className="text-xs text-muted-foreground uppercase tracking-wide">
                  Active Users
              ...
              <div className="text-center">
                <div className="text-2xl font-black text-secondary hud-value">
                  $2.4M+
                </div>
                <div className="text-xs text-muted-foreground uppercase tracking-wide">
                  Total Profits
