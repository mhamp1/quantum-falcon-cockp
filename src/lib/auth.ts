...
export const LICENSE_TIERS: Record<string, LicenseTier> = {
  ...
  starter: {
    ...
    strategiesUnlocked: ['DCA Basic', 'DCA Advanced', 'RSI Strategy', 'Paper Trading'],
    maxAgents: 1,
    xpMultiplier: 1.5,
  ...
  trader: {
    ...
    strategiesUnlocked: ['DCA Basic', 'DCA Advanced', 'RSI Strategy', 'MACD Strategy', 'Momentum Basic', 'Paper Trading'],
    maxAgents: 2,
    xpMultiplier: 2,
    specialPerks: ['Speed Boost Access', 'Priority Trade Execution', 'Enhanced Analytics']
  },
  pro: {
    id: 'pro',
    name: 'Pro Trader',
  ...
  elite: {
    ...
    strategiesUnlocked: [
      'DCA Basic', 'DCA Advanced', 'Momentum Basic', 'Momentum Advanced',
      'RSI Strategy', 'MACD Strategy', 'Bollinger Bands', 'Mean Reversion',
      'Token Sniping', 'Arbitrage Scanner', 'Custom Strategies', 'Paper Trading'
    ],
    maxAgents: 5,
    xpMultiplier: 4,
    specialPerks: [
