...
export const ALL_ROTATING_OFFERS: RotatingOffer[] = [
  {
    ...
    description:
      "Ultra-fast entry with sub-second timing and automatic slippage guard for new token launches",
    price: 7.99,
    icon: Target,
    category: "trading",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Real-time alerts on top 10 whale wallet movements with instant notifications",
    price: 9.99,
    icon: Eye,
    category: "analytics",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Auto-buy with advanced RSI and MACD filters for perfect entry timing",
    price: 6.99,
    icon: GitBranch,
    category: "trading",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Real-time cross-exchange spread detection with automatic execution suggestions",
    price: 12.99,
    icon: ChartBar,
    category: "trading",
    duration: 336,
  ...
  },
  {
    ...
    description:
      "Automatic protective short positions triggered by volatility spikes",
    price: 8.99,
    icon: ShieldCheck,
    category: "trading",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Jump to the front of the trade queue during high-traffic periods",
    price: 4.99,
    icon: Rocket,
    category: "trading",
    duration: 72,
  ...
  },
  {
    ...
    description:
      "Unlock unlimited micro-trade automation for high-frequency strategies",
    price: 15.99,
    icon: Lightning,
    category: "trading",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "AI-powered trailing stop-loss that adapts to market conditions",
    price: 5.99,
    icon: Brain,
    category: "trading",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Advanced whale accumulation zone detection with smart money flow analysis",
    price: 9.99,
    icon: Brain,
    category: "analytics",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "AI-driven trend detection with automatic chart pattern overlay",
    price: 8.99,
    icon: TrendUp,
    category: "analytics",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Real-time social media sentiment analysis from Twitter, Reddit, and Discord",
    price: 12.99,
    icon: Broadcast,
    category: "analytics",
    duration: 336,
  ...
  },
  {
    ...
    description:
      "Visual sector performance heatmap with real-time data visualization",
    price: 6.99,
    icon: Graph,
    category: "analytics",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Precision entry and exit signals based on multi-timeframe RSI analysis",
    price: 7.99,
    icon: Crosshair,
    category: "analytics",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Instant alerts when trading volume spikes beyond normal patterns",
    price: 5.99,
    icon: ChartLineUp,
    category: "analytics",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Automatic candlestick pattern detection and tagging on charts",
    price: 8.99,
    icon: ChartBar,
    category: "analytics",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Comprehensive portfolio risk analysis with stress testing scenarios",
    price: 11.99,
    icon: Gauge,
    category: "analytics",
    duration: 336,
  ...
  },
  {
    ...
    description:
      "Animated holographic card frames with rainbow shimmer effects",
    price: 3.99,
    icon: Sparkle,
    category: "cosmetic",
    duration: 72,
  ...
  },
  {
    ...
    description:
      "Friendly AI mascot that reacts to your trades and achievements",
    price: 4.99,
    icon: Alien,
    category: "cosmetic",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Animated cyberpunk city background with neon lights and rain effects",
    price: 5.99,
    icon: Planet,
    category: "cosmetic",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Exclusive animated badge displayed on your profile and in community",
    price: 3.99,
    icon: Medal,
    category: "cosmetic",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Sci-fi inspired sound effects for trades, alerts, and notifications",
    price: 4.99,
    icon: MusicNotes,
    category: "cosmetic",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Automatically rotating gradient color schemes that change every hour",
    price: 5.99,
    icon: Palette,
    category: "cosmetic",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Hollywood-style page transitions with motion blur and fade effects",
    price: 3.99,
    icon: Camera,
    category: "cosmetic",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Feature your profile prominently in the community tab for 3 days",
    price: 9.99,
    icon: Star,
    category: "community",
    duration: 72,
  ...
  },
  {
    ...
    description:
      "Gain moderator privileges in community chat and forums for 7 days",
    price: 14.99,
    icon: Crown,
    category: "community",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Your votes count 2x in all community polls and decisions for 14 days",
    price: 5.99,
    icon: Trophy,
    category: "community",
    duration: 336,
  ...
  },
  {
    ...
    description:
      "Access secret forum thread with elite trading strategies and insights",
    price: 12.99,
    icon: Lock,
    category: "community",
    duration: 336,
  ...
  },
  {
    ...
    description:
      "XP doubled when co-building strategies with other users for 7 days",
    price: 8.99,
    icon: Users,
    category: "community",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Get randomly paired with a pro trader for 1-on-1 mentorship session",
    price: 24.99,
    icon: Users,
    category: "community",
  ...
  },
  {
    ...
    description:
      "Special badge for having code merged into the main repository",
    price: 0,
    icon: Medal,
    category: "community",
    benefit1: "Dev badge",
  ...
  },
  {
    ...
    description:
      "Special one-time milestone card celebrating your trading journey",
    price: 4.99,
    icon: Trophy,
    category: "community",
  ...
  },
  {
    ...
    description:
      "Temporary trusted device 2FA bypass with full audit logging for 24h",
    price: 1.99,
    icon: Key,
    category: "security",
    duration: 24,
  ...
  },
  {
    ...
    description:
      "Comprehensive security audit of your account with recommendations",
    price: 9.99,
    icon: ShieldCheck,
    category: "security",
    benefit1: "Full audit",
  ...
  },
  {
    ...
    description:
      "End-to-end encrypted messaging with custom UI skin for privacy",
    price: 6.99,
    icon: Lock,
    category: "security",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Temporary extra vault slot for segregating different strategies",
    price: 4.99,
    icon: Database,
    category: "security",
    duration: 72,
  ...
  },
  {
    ...
    description:
      "Open for a random reward: XP, cosmetics, or temporary feature access",
    price: 4.99,
    icon: Gift,
  ...
  },
  {
    ...
    description:
      "Unlock premium daily challenges with 3x XP rewards for 7 days",
    price: 5.99,
    icon: Target,
    category: "gamification",
    duration: 168,
  ...
  },
  {
    ...
    description:
      "Solve trading-themed puzzles to earn bonus XP and unlock rewards",
    price: 2.99,
    icon: GameController,
    category: "gamification",
  ...
  },
  {
    ...
    description:
      "Answer crypto trading trivia questions for instant XP rewards",
    price: 1.99,
    icon: Brain,
    category: "gamification",
  ...
  },
  {
    ...
    description:
      "Rare card that randomly cycles in with massive XP bonus and special badge",
    price: 0,
    icon: Diamond,
    category: "gamification",
